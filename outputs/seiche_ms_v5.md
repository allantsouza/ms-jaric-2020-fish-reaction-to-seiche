...
<a href="https://www.codecogs.com/eqnedit.php?latex=\boldsymbol{E\left&space;(&space;y_{i}&space;\right&space;)}=&space;\beta_{0}&space;&plus;&space;f_{1}\left&space;(&space;X_{1i}&space;\right&space;)&space;&plus;&space;f_{2}\left&space;(&space;X_{1i}&space;\cdot&space;\gamma_{1i}&space;)&space;&plus;&space;\right&space;\)&space;&plus;&space;f_{3}\left&space;(&space;X_{2i}&space;\right&space;)&space;&plus;&space;f_{4}\left&space;(&space;X_{2i}&space;\cdot&space;\gamma_{1i}&space;)&space;&plus;&space;\right&space;\)&space;&plus;&space;f_{5}\left&space;(&space;X_{3i}&space;\right&space;)&space;&plus;&space;f_{6}\left&space;(&space;X_{3i}&space;\cdot&space;\gamma_{1i}&space;)&space;&plus;&space;\right&space;\)&space;&plus;&space;f_{7}\left&space;(&space;t_{4i}&space;\right&space;)&space;&plus;&space;\gamma_{01}&space;&plus;&space;\varepsilon_{}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\boldsymbol{E\left&space;(&space;y_{i}&space;\right&space;)}=&space;\beta_{0}&space;&plus;&space;f_{1}\left&space;(&space;X_{1i}&space;\right&space;)&space;&plus;&space;f_{2}\left&space;(&space;X_{1i}&space;\cdot&space;\gamma_{1i}&space;)&space;&plus;&space;\right&space;\)&space;&plus;&space;f_{3}\left&space;(&space;X_{2i}&space;\right&space;)&space;&plus;&space;f_{4}\left&space;(&space;X_{2i}&space;\cdot&space;\gamma_{1i}&space;)&space;&plus;&space;\right&space;\)&space;&plus;&space;f_{5}\left&space;(&space;X_{3i}&space;\right&space;)&space;&plus;&space;f_{6}\left&space;(&space;X_{3i}&space;\cdot&space;\gamma_{1i}&space;)&space;&plus;&space;\right&space;\)&space;&plus;&space;f_{7}\left&space;(&space;t_{4i}&space;\right&space;)&space;&plus;&space;\gamma_{01}&space;&plus;&space;\varepsilon_{}" title="\boldsymbol{E\left ( y_{i} \right )}= \beta_{0} + f_{1}\left ( X_{1i} \right ) + f_{2}\left ( X_{1i} \cdot \gamma_{1i} ) + \right \) + f_{3}\left ( X_{2i} \right ) + f_{4}\left ( X_{2i} \cdot \gamma_{1i} ) + \right \) + f_{5}\left ( X_{3i} \right ) + f_{6}\left ( X_{3i} \cdot \gamma_{1i} ) + \right \) + f_{7}\left ( t_{4i} \right ) + \gamma_{01} + \varepsilon_{}" /></a>
